...
import net.silentchaos512.borderblocks.client.TextEffectDisplayHandler.TextEffect;
...
public class TextEffectDisplayHandler {
  ...
  List<TextEffect> effectList = new ArrayList<>();
  ...
  public static class TextEffect {
    ...
    public TextEffect(String text, int color, int posX, int posY, int life, float startScale,
        float endScale, int fadeTime) {
...
//      fontRender.drawString(text, 1, 0, 0);
//      fontRender.drawString(text, -1, 0, 0);
//      fontRender.drawString(text, 0, 1, 0);
//      fontRender.drawString(text, 0, -1, 0);
