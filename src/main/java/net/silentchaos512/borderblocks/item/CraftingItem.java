...
public class CraftingItem extends ItemNamedSubtypesSorted {
  ...
  public static final String[] NAMES = { NAME_SCRAP, NAME_SCRAP_PILE, NAME_ERIDIUM_INGOT };
  public static final String[] SORTED_NAMES = { NAME_SCRAP, NAME_SCRAP_PILE, NAME_ERIDIUM_INGOT };
