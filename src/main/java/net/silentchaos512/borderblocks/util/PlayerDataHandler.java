...
public class PlayerDataHandler {
  ...
  public static final String NBT_ROOT = Borderblocks.MOD_ID + "_data";
  ...
  public static class PlayerData {
    ...
    public static final String NBT_ACTIVE_KILL_SKILLS = "active_kill_skills";
    public static final String NBT_CHARACTER_CLASS = "character_class";
    ...
    public static final String NBT_XP = "xp";
    ...
    /**
     * Give XP for mining. Unlike addXp, this accumulates until the player stops mining, to prevent spamming the "+XP"
     * text.
     */
    ...
    /**
     * Gets the total number of skill points the player has. This is calculated based on level, the value is never
     * stored.
     */
    ...
    /**
     * Add a point to (level up) a skill, or add it to the player's skills if they do not already have it.
     * 
     * @param skill
     *          The skill to add a point to
     * @return True if adding a point was successful, false otherwise (e.g. the skill already has max points)
     */
    ...
    /**
     * Level up the player, increasing level and doing anything else that may accompany a level up.
     */
