...
public class WorldGenEridium extends WorldGenMinable {
  ...
  protected boolean tryPlaceLava(World world, BlockPos pos, boolean canRecurse) {
...
//      Borderblocks.log.debug(isSurrounded, pos);
      if (isSurrounded) {
  ...
  protected boolean supportsLava(World world, BlockPos pos) {
